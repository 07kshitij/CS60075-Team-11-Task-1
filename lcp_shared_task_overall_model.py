...
model_NN.to(device)
# best_NN_single = model_NN
# best_single_path = './TrainedModels/NN_single_best.pt'
...
if USE_PRETRAINED_SINGLE_WORD_TARGET_NN:
  ...
  # best_single_path = './TrainedModels/NN_0.731.pt'
  ...
  for epoch in range(NUM_EPOCHS):
    ...
    # if testR > bestR_single:
    #   bestR_single = testR
    #   torch.save(model_NN, best_single_path)
    print("Epoch {} : Train R = {} | Test R = {}".format(epoch + 1, round(trainR, 6), round(testR, 6)))

# best_NN_single = torch.load(best_single_path)
# best_NN_single.eval()
...
# best_NN_multi = model_NN_multi
# best_multi_path = './TrainedModels/NN_multi_best.pt'
...
if USE_PRETRAINED_MULTI_WORD_TARGET_NN:
  ...
  for epoch in range(NUM_EPOCHS):
    ...
    # if testR > bestR_multi:
    #   bestR_multi = testR
    #   torch.save(model_NN_multi, best_multi_path)
    print("Epoch {} : Train R = {} | Test R = {}".format(epoch + 1, round(trainR, 6), round(testR, 6)))

# best_NN_multi = torch.load(best_multi_path)
# best_NN_multi.eval()
